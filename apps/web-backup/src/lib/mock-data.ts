...
export const specs: Spec[] = [
  {
    ...
    problem: "There is an existing integration but we need to review it before making changes.",
    expectedBehavior: "Provide a clear understanding of the existing integration.",
    acceptanceCriteria: [
    ...
    outOfScope: ["Refactoring the integration", "Fixing bugs found during review"],
    openQuestions: [
    ...
    suggestedSearchTerms: ["TBS", "integration"],
    verificationPlan: ["Run tests to ensure no regressions"],
  ...
  },
  {
    ...
    riskLevel: "low",
    agentTargets: ["claude_code", "codex", "cursor", "github_copilot", "generic_markdown"],
    verificationPlan: ["Run e2e tests for invite flow"],
  ...
  },
  {
    ...
    riskLevel: "medium",
    agentTargets: ["claude_code", "codex", "cursor", "github_copilot", "generic_markdown"],
    verificationPlan: ["Run import workers tests"],
