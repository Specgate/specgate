...
export const POST = (request: Request) =>
  handleApi(request, async ({ ctx, runtime }) =>
    runtime.planning.createMilestone(
      ctx,
      await readJson(request, MilestoneInputSchema),
    ),
  );
